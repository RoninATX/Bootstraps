...
create_interactive_config() {
  ...
  read -rsp "Cloudflare API key/token: " api_key
  echo
  while [[ -z "$api_key" ]]; do
    echo "API key/token cannot be empty."
    read -rsp "Cloudflare API key/token: " api_key
    echo
  done
...

  {
    ...
    echo "CLOUDFLARE_API_KEY=\"$api_key\""
    echo 'TTL="3000"'
    echo 'TYPE="A"'
    echo
...
CLOUDFLARE_API_KEY="paste-your-global-api-key-or-token"
TTL="3000"
TYPE="A"
